[![Chrome Web Store Users](https://img.shields.io/chrome-web-store/users/xxxchromexxx?logo=google&logoColor=white&label=google%20users)](https://chrome.google.com/webstore/detail/open-links-in-new-tab/xxxchromexxx)
...
[![Chrome Web Store Version](https://img.shields.io/chrome-web-store/v/xxxchromexxx?label=chrome&logo=googlechrome)](https://chrome.google.com/webstore/detail/open-links-in-new-tab/xxxchromexxx)
...
*   [Google Chrome Web Store](https://chrome.google.com/webstore/detail/open-links-in-new-tab/xxxchromexxx)
*   [Mozilla Firefox Add-ons](https://addons.mozilla.org/addon/open-links-in-new-tab)

<a href="https://chrome.google.com/webstore/detail/open-links-in-new-tab/xxxchromexxx" target="_blank">
...
[Chrome Web Store](https://chrome.google.com/webstore/detail/open-links-in-new-tab/xxxchromexxx).
